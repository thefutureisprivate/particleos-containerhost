...
require_fixed 'systemd.unit-dropin.preset-global.service~90-particleos-audit' tests/run-update-rollback-audit.sh 'update audit starts on the initial factory boot as well as later boots'
