...
require_fixed 'Before=systemd-network-generator.service systemd-pcrmachine.service systemd-udev-load-credentials.service systemd-udev-trigger.service' mkosi.extra/usr/lib/systemd/system/systemd-modules-load.service.d/40-particleos-ordering.conf 'root-side sysinit waits for the fixed module preload'
