...
require_fixed 'run0 rejected the homed administrator password' tests/firstboot-console-audit 'the native account must authenticate run0'
require_fixed 'PARTICLEOS_FIRSTBOOT_CONSOLE_PASS ' tests/firstboot-console-audit 'the native provisioning audit has an unambiguous success marker'
